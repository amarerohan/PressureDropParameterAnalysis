...
pa2 = np.load('case'+str(c2)+'/flow_solutions/'+str(e1)+'/prs_acomp_' + str(e1) +'_Pin_1000_Pout_1.npy')
pv2 = np.load('case'+str(c2)+'/flow_solutions/'+str(e1)+'/prs_vcomp_' + str(e1) +'_Pin_1000_Pout_1.npy')
...
for z in range(1,nz-1):
    ...
    color = 'BuPu' # plt.cm.get_cmap('Reds') 
    
    plt.subplot(121)
    
    plt.contourf(pa1[1:-1,1:-1,z],np.arange(P_min,P_max+2*dP,dP),cmap=color)#.reversed())
    # plt.colorbar()
    plt.axis('off')
    ...
    plt.subplot(122)
    plt.contourf(pa2[1:-1,1:-1,z],np.arange(P_min,P_max+2*dP,dP),cmap=color)#.reversed())
    # plt.colorbar()
    plt.axis('off')
...
'''
X2 = np.load('case'+str(c2)+'/flow_solutions/'+'Heat_X_' + str(e2) + '_a_0.001_q_1000_Tin_20_Tamb_0_hamb_10_hbt_10_.npy')
