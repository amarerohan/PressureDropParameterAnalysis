...
# dT4 = np.load('Temperature_error_4_1.npy')
# dT5 = np.load('Temperature_error_5_1.npy')

# th2 = np.load('Theta_error_2_1.npy')
th3 = np.load('Theta_error_3_1.npy')
# th4 = np.load('Theta_error_4_1.npy')
# th5 = np.load('Theta_error_5_1.npy')
...
dT3_array = np.arange(-dT3_max, dT3_max + 1*dT3_max/n, 2*dT3_max/n)
...
for z in z_array:
    ...
    plt.subplot(2,2,1)
    plt.contourf(T_tis1[0:-1,0:-1,z], np.arange(28,37,1), cmap = 'Reds')
    plt.axis('off')
    plt.title('(a)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    cbar.set_label('Temperature ($^oC$)', rotation=270,labelpad=+65,font=font)
    
    plt.subplot(2,2,2)
    plt.contourf(T_tis2[0:-1,0:-1,z], np.arange(28,37,1), cmap = 'Reds')
    plt.axis('off')
    ...
    plt.savefig('New_Temperature_plots/combo_case_2_z_'+str(z)+'.png',dpi = 100, bbox_inches='tight')
    plt.show()
...
for z in z_array:
    ...
    plt.subplot(2,2,2)
    plt.contourf(T_tis3[0:-1,0:-1,z], np.arange(28,37,1), cmap = 'Reds')
    plt.axis('off')
    plt.title('(b)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.subplot(2,2,3)
    plt.contourf(dT3[0:-1,0:-1,z], dT3_array, cmap = 'RdBu')#, np.arange(()))
    plt.axis('off')
    plt.title('(c)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.subplot(2,2,4)
    plt.contourf(th3[0:-1,0:-1,z], th3_array, cmap = 'RdBu')#, np.arange(()))
    plt.axis('off')
    plt.title('(d)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.savefig('New_Temperature_plots/combo_case_3_z_'+str(z)+'.png',dpi = 100, bbox_inches='tight')
    plt.show()
...
for z in z_array:
    ...
    plt.subplot(2,2,2)
    plt.contourf(T_tis4[0:-1,0:-1,z], np.arange(28,37,1), cmap = 'Reds')
    plt.axis('off')
    plt.title('(b)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.subplot(2,2,3)
    plt.contourf(dT4[0:-1,0:-1,z], dT4_array, cmap = 'RdBu')#, np.arange(()))
    plt.axis('off')
    plt.title('(c)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.subplot(2,2,4)
    plt.contourf(th4[0:-1,0:-1,z], th4_array, cmap = 'RdBu')#, np.arange(()))
    plt.axis('off')
    plt.title('(d)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.savefig('New_Temperature_plots/combo_case_4_z_'+str(z)+'.png',dpi = 100, bbox_inches='tight')
    plt.show()
...
for z in z_array:
    ...
    plt.subplot(2,2,2)
    plt.contourf(T_tis5[0:-1,0:-1,z], np.arange(28,37,1), cmap = 'Reds')
    plt.axis('off')
    plt.title('(b)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.subplot(2,2,3)
    plt.contourf(dT5[0:-1,0:-1,z], dT5_array, cmap = 'RdBu')#, np.arange(()))
    plt.axis('off')
    plt.title('(c)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.subplot(2,2,4)
    plt.contourf(th5[0:-1,0:-1,z], th5_array, cmap = 'RdBu')#, np.arange(()))
    plt.axis('off')
    plt.title('(d)', y = -0.075, font=font)
    cbar = plt.colorbar()
    cbar.ax.tick_params(labelsize = 65)
    ...
    plt.savefig('New_Temperature_plots/combo_case_5_z_'+str(z)+'.png',dpi = 100, bbox_inches='tight')
    plt.show()
