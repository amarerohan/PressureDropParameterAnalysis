...
for z in z_array:
    ...
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(71*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,2)
    plt.contourf(dT2[0:-1,0:-1,z], dT_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(75*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,3)
    plt.contourf(dT3[0:-1,0:-1,z], dT_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(80*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,4)
    plt.contourf(dT4[0:-1,0:-1,z], dT_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(85*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,5)
    plt.contourf(dT5[0:-1,0:-1,z], dT_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(90*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,6)
    plt.contourf(dT6[0:-1,0:-1,z], dT_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(95*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,7)
    plt.contourf(dT7[0:-1,0:-1,z], dT_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = $'+ str(round(100*2.5,1)) +' mm', y = -0.075, fontsize = f, font = font)
    
    cax = plt.axes([1.00, 0.01, 0.022, 0.98])
    cbar = plt.colorbar(cax=cax)
    cbar.ax.tick_params(labelsize = 65)
    cbar.set_label('Temperature difference ($^oC$)', rotation=270,labelpad=+65,font=font, fontsize = 75)
    
    plt.tight_layout()
    
    plt.savefig('New_Temperature_plots/Effect_of_SoI_for_Kt_' + str(kt) + '_z_' + str(z) + '.png', dpi = 100, bbox_inches='tight')
...
for z in z_array:
    ...
    plt.axis('off')
    plt.title('$\epsilon = 71$ mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,2)
    plt.contourf(th2[0:-1,0:-1,z], th_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = 75$ mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,3)
    plt.contourf(th3[0:-1,0:-1,z], th_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = 80$ mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,4)
    plt.contourf(th4[0:-1,0:-1,z], th_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = 85$ mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,5)
    plt.contourf(th5[0:-1,0:-1,z], th_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = 90$ mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,6)
    plt.contourf(th6[0:-1,0:-1,z], th_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = 95$ mm', y = -0.075, fontsize = f, font = font)
    
    plt.subplot(2,4,7)
    plt.contourf(th7[0:-1,0:-1,z], th_array, cmap = colors)
    plt.axis('off')
    plt.title('$\epsilon = 100$ mm', y = -0.075, fontsize = f, font = font)
    
    cax = plt.axes([1.00, 0.01, 0.022, 0.98])
    cbar = plt.colorbar(cax=cax)
    cbar.ax.tick_params(labelsize = 65)
    cbar.set_label('$\theta$', rotation=270,labelpad=+65,font=font, fontsize = 75)
